...
static param_descriptor_data const effect_dly_hold_time_data = { { "Hold time", "Delay hold time" }, "Sec", param_kind::voice, quad_bounds(effect_dly_hold_min_time_sec, effect_dly_hold_max_time_sec, "0", 3) };
static param_descriptor_data const effect_dly_hold_tempo_data = { { "Hold tempo", "Delay hold tempo" }, "", param_kind::voice, param_type::knob_list, { &effect_dly_hold_timesig_names, "1/4" } };
