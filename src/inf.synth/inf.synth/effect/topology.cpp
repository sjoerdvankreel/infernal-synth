...
static param_descriptor_data const effect_dly_hold_tempo_data = { { "Hold", "Delay hold tempo" }, "", param_kind::voice, param_type::knob_list, { &effect_dly_hold_timesig_names, "1/4" } };
