...
inline std::int32_t constexpr vaudio_bank_table_col_count = vaudio_bank_route_count + 1;
inline char const* const vaudio_bank_table_row_headers[audio_bank_param_type::count] = { "In", "Out", "Amt", "Bal" };
inline float const vaudio_bank_table_col_widths[vaudio_bank_table_col_count] = { 0.07f, 0.155f, 0.155f, 0.155f, 0.155f, 0.155f, 0.155f };
inline base::part_table_descriptor const vaudio_bank_table = { true, vaudio_bank_table_col_count, vaudio_bank_table_col_widths, vaudio_bank_table_row_headers };

// ---- global ----

std::vector<base::box_descriptor> gaudio_bank_borders();
extern base::param_descriptor const gaudio_bank_params[];
inline std::int32_t constexpr gaudio_bank_table_col_count = audio_bank_param_type::count * 2;
inline float const gaudio_bank_table_col_widths[gaudio_bank_table_col_count] = { 0.09f, 0.11f, 0.15f, 0.15f, 0.09f, 0.11f, 0.15f, 0.15f };
inline char const* const gaudio_bank_table_col_headers[gaudio_bank_table_col_count] = { "In", "Out", "Amt", "Bal", "In", "Out", "Amt", "Bal" };
inline base::part_table_descriptor const gaudio_bank_table = { false, gaudio_bank_table_col_count, gaudio_bank_table_col_widths, gaudio_bank_table_col_headers };
