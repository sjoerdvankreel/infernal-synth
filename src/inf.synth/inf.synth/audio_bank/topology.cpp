...
{  
  ...
  { "{91996C1F-4510-4BC1-97BA-135C9881263F}", { { "Bal", "Stereo balance 1" }, "%", param_kind::continuous, linear_bounds(0.0f, 1.0f, 0.5f, -100.0f, 100.0f, 1) } },
  { "{265269F4-F6DF-474E-A696-44EE01681C65}", { { "Bal", "Stereo balance 2" }, "%", param_kind::continuous, linear_bounds(0.0f, 1.0f, 0.5f, -100.0f, 100.0f, 1) } },
  { "{64C90CE2-2AC0-4675-8F99-B88E807F712A}", { { "Bal", "Stereo balance 3" }, "%", param_kind::continuous, linear_bounds(0.0f, 1.0f, 0.5f, -100.0f, 100.0f, 1) } },
  { "{01B6309E-B045-48A7-9BC1-8E828A528A3F}", { { "Bal", "Stereo balance 4" }, "%", param_kind::continuous, linear_bounds(0.0f, 1.0f, 0.5f, -100.0f, 100.0f, 1) } },
  { "{77F5DF0C-B9E8-4059-AE8B-75B9D6E3E0CE}", { { "Bal", "Stereo balance 5" }, "%", param_kind::continuous, linear_bounds(0.0f, 1.0f, 0.5f, -100.0f, 100.0f, 1) } },
  { "{EF2AD9AF-0A3C-4DD7-8650-5DD6974C4625}", { { "Bal", "Stereo balance 6" }, "%", param_kind::continuous, linear_bounds(0.0f, 1.0f, 0.5f, -100.0f, 100.0f, 1) } }
};
...
gaudio_bank_params[audio_bank_param::count] = 
{
  ...
  { "{EBBBAC9E-3D8F-482A-A41B-32CB47324647}", { { "Bal", "Stereo balance 4" }, "%", param_kind::continuous, linear_bounds(0.0f, 1.0f, 0.5f, -100.0f, 100.0f, 1) } },
  { "{80D09377-31F5-4162-A785-D0B841FCDBA6}", { { "Bal", "Stereo balance 5" }, "%", param_kind::continuous, linear_bounds(0.0f, 1.0f, 0.5f, -100.0f, 100.0f, 1) } },
  { "{7E72F00C-2C26-4BAD-98E5-ADC7168852F7}", { { "Bal", "Stereo balance 6" }, "%", param_kind::continuous, linear_bounds(0.0f, 1.0f, 0.5f, -100.0f, 100.0f, 1) } }
};
