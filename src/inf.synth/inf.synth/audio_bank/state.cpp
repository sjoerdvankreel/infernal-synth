...
{
  part_type::vaudio_bank, vaudio_bank_route_count, vcv_route_output::vaudio_bank, vaudio_route_output_total_count,
...
{
  part_type::gaudio_bank, gaudio_bank_route_count, gcv_route_output::gaudio_bank, gaudio_route_output_total_count,
