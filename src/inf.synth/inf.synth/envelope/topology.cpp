...
envelope_params[envelope_param::count] =
{
  ...
  { "{70C49337-7141-42BC-B336-78B28F4770E3}", { { "Delay", "Delay tempo" }, "", param_kind::voice, param_type::knob_list, { &envelope_timesig_names, "0" } } },
  ...
  { "{AC5D88B7-8CDB-4401-9FB0-20EF0195ABD8}", { { "Hold", "Hold tempo" }, "", param_kind::voice, param_type::knob_list, { &envelope_timesig_names, "0" } } },
