...
envelope_params[envelope_param::count] =
{
  ...
  { "{9D1275BC-9206-4CEA-B109-51974951B3DB}", { { "Splt", "Attack split" }, "%", param_kind::voice, percentage_01_bounds(1.0f) } },
  ...
  { "{57776D47-48CE-4912-A6D4-60153980B8A4}", { { "Splt", "Decay split" }, "%", param_kind::voice, percentage_01_bounds(0.0f) } },
  ...
  { "{38F801F5-7F13-4B8C-AE46-0E94B3D75147}", { { "Splt", "Release split" }, "%", param_kind::voice, percentage_01_bounds(0.0f) } },
