...
static std::vector<list_item> const usage_sources = {
  { "{05D497C4-2188-4B81-AB5E-586233FB69ED}", "Aux" },
...
{ 
  ...
  { "{C0AB0784-45BB-4C2E-AF4F-F236EFCF4C6D}", { { "High", "Highest usage module" }, "", param_kind::output, param_type::list, { &usage_sources, usage_source::aux }, 4, nullptr } },
