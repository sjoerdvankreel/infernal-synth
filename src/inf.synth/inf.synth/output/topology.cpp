...
static std::vector<list_item> const usage_sources = {
  { "{EF08E89F-BA8D-4351-B884-28CED7C666DA}", "VAmp" },
  { "{6DA9D3AA-0AF1-46F3-A99C-46617B3283D9}", "GAmp" },
  { "{A9F10C03-1757-4759-B127-82CD86B61ED7}", "VAudio" },
  { "{8C9A10BD-B98A-449F-B8D0-5F41E5BC81EE}", "GAudio" },
  { "{7B4AE600-57E3-43DC-AED9-0FA987B96E80}", "VCV" },
  { "{5A264DA4-D514-4BBD-9A88-46A2E099F319}", "GCV" }, 
