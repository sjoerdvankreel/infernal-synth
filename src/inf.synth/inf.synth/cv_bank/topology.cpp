...
static list_item const vcv_route_audio_bank_targets[vgcv_route_audio_bank_target::vaudio_count] = {
  ...
  { "{15BFD0CB-C029-4DA0-AD3E-58A5A5310F34}", "Amt16" },
  { "{C8511F7F-F27C-4AE3-A37F-E65AD400876B}", "Bal16" },
  { "{1B6132A4-68E9-4949-AD0C-A910E24C23FD}", "Amt17" },
  { "{D3BC8E67-5288-4CFD-9EEB-4DBC24F1FB2B}", "Bal17" },
  { "{287F6ABA-51C5-4CFA-91F2-FFED0BAA3C8A}", "Amt18" },
  { "{96887DAF-FABC-4B6B-86E6-D0C14280249D}", "Bal18" },
  { "{15A26AED-1F57-43DC-BF44-97755FC31A7B}", "Amt19" },
  { "{4468283B-98D3-48DC-BF54-3C63EC6111E6}", "Bal19" },
  { "{29D7E987-0937-4E04-9A26-279C231E1C3B}", "Amt20" },
  { "{9141F4DC-C7D2-4D7E-B732-DF16C6930A42}", "Bal20" },
  { "{1DF21879-BCC1-4497-BB3E-71ABA9D09AFC}", "Amt21" },
  { "{A36A0CBC-3350-43EF-9C69-6F553817E8A9}", "Bal21" },
  { "{1DFAE194-EA69-42DB-B15E-81594C90A240}", "Amt22" },
  { "{C4E8ADB1-E726-4643-A01F-FB462503BED8}", "Bal22" },
  { "{284F22A4-B13A-4A1F-A39F-A32C8D2DFD50}", "Amt23" },
  { "{EA61774D-E130-4F1B-921B-E4616052335E}", "Bal23" },
  { "{FF58892B-0097-4B60-9C3F-DFBF10B379DC}", "Amt24" },
  { "{00BC00AB-7E09-4024-9087-C657B5F0158D}", "Bal24" } };
static list_item const gcv_route_audio_bank_targets[vgcv_route_audio_bank_target::gaudio_count] = {
  ...
  { "{AF20EA99-6827-4216-8CBA-5562F267F649}", "Amt7" },
  { "{5B761DB0-688C-4396-96C5-2EE97A5513D0}", "Bal7" },
  { "{44183897-5277-4A02-BED5-8D727E6C9C33}", "Amt8" },
  { "{95126B9B-953F-4C21-870A-44C2D9396832}", "Bal8" },
  { "{2FA260E6-6384-4FE6-9D90-46AC3A4FCF28}", "Amt9" },
  { "{CDB20D33-4427-4C70-BAFC-6B4A0A472757}", "Bal9" },
  { "{01B5D903-C453-4CB4-AEC2-39F88CC1A46B}", "Amt10" },
  { "{8308F1EE-2CB1-4F70-9644-118DC9798161}", "Bal10" },
  { "{04A4A4AF-B47A-4D35-B8DA-9500DE85506D}", "Amt11" },
  { "{9B7D5409-979C-40B3-8437-B012146C8C8D}", "Bal11" },
  { "{E77ADEBB-87A4-4329-9D9F-869E5AD0489F}", "Amt12" },
  { "{DFB56B42-17E3-4855-A6B4-7C3CC1F224D7}", "Bal12" },
  { "{AF20EA99-6827-4216-8CBA-5562F267F649}", "Amt13" },
  { "{5B761DB0-688C-4396-96C5-2EE97A5513D0}", "Bal13" },
  { "{44183897-5277-4A02-BED5-8D727E6C9C33}", "Amt14" },
  { "{95126B9B-953F-4C21-870A-44C2D9396832}", "Bal14" },
  { "{2FA260E6-6384-4FE6-9D90-46AC3A4FCF28}", "Amt15" },
  { "{CDB20D33-4427-4C70-BAFC-6B4A0A472757}", "Bal15" },
  { "{01B5D903-C453-4CB4-AEC2-39F88CC1A46B}", "Amt16" },
  { "{8308F1EE-2CB1-4F70-9644-118DC9798161}", "Bal16" },
  { "{04A4A4AF-B47A-4D35-B8DA-9500DE85506D}", "Amt17" },
  { "{9B7D5409-979C-40B3-8437-B012146C8C8D}", "Bal17" },
  { "{E77ADEBB-87A4-4329-9D9F-869E5AD0489F}", "Amt18" },
  { "{DFB56B42-17E3-4855-A6B4-7C3CC1F224D7}", "Bal18" } };
...
{
  { "{CE1DC1C7-72C5-4811-8C35-8485FFAFFABC}", { {"Tgt", "Target"}, "", param_kind::block, param_type::list, {&vcv_route_output_target_list, "Voice Gain" } } },
...
{
  { "{EBF618A3-D50D-439C-A2BA-95C06277276E}", { {"Tgt", "Target"}, "", param_kind::block, param_type::list, {&gcv_route_output_target_list, "Master Gain" } } },
...
{        
  ...
  { "{0C1E5C81-01EE-4AE6-A05C-199210B904CC}", { { "Offset", "Offset 1" }, "%", param_kind::continuous, percentage_01_bounds(0.0f) } },
  { "{20F28A5F-2956-412E-BD97-9220836C22A3}", { { "Offset", "Offset 2" }, "%", param_kind::continuous, percentage_01_bounds(0.0f) } },
  { "{BFFA2360-5A5F-4575-A0E4-32B8B74977BD}", { { "Offset", "Offset 3" }, "%", param_kind::continuous, percentage_01_bounds(0.0f) } },
  { "{B46AC7BD-982C-4A9D-B74B-AE27C25BE811}", { { "Offset", "Offset 4" }, "%", param_kind::continuous, percentage_01_bounds(0.0f) } },
  { "{542280B8-942D-4FAA-AB26-5A39CE3FFF71}", { { "Offset", "Offset 5" }, "%", param_kind::continuous, percentage_01_bounds(0.0f) } },
  { "{20ACF437-2158-4900-8DC4-D36767442BF1}", { { "Scale", "Scale 1" }, "%", param_kind::continuous, percentage_01_bounds(1.0f) } },
  { "{23EFCBDF-7744-4527-B82D-A69E56C7338B}", { { "Scale", "Scale 2" }, "%", param_kind::continuous, percentage_01_bounds(1.0f) } },
  { "{87087F9C-62A2-4804-9292-CD9089F025B7}", { { "Scale", "Scale 3" }, "%", param_kind::continuous, percentage_01_bounds(1.0f) } },
  { "{D58E30EB-8F46-4EB7-84F2-37AA48F81721}", { { "Scale", "Scale 4" }, "%", param_kind::continuous, percentage_01_bounds(1.0f) } },
  { "{62A7448C-3245-4B33-AF4E-42D98D3AD547}", { { "Scale", "Scale 5" }, "%", param_kind::continuous, percentage_01_bounds(1.0f) } }
};
...
{ 
  ...
  { "{41F96374-D208-4A29-911E-18CF7C27A6A0}", { { "Offset", "Offset 1" }, "%", param_kind::continuous, percentage_01_bounds(0.0f) } },
  { "{4CBAC51D-9597-48BF-9210-D9CA33E8DCD1}", { { "Offset", "Offset 2" }, "%", param_kind::continuous, percentage_01_bounds(0.0f) } },
  { "{D2EF64CE-1737-4776-AD8D-F28D5E359960}", { { "Offset", "Offset 3" }, "%", param_kind::continuous, percentage_01_bounds(0.0f) } },
  { "{44061640-FDE6-4E81-BDE0-6145A6EBD494}", { { "Offset", "Offset 4" }, "%", param_kind::continuous, percentage_01_bounds(0.0f) } },
  { "{31E160CE-5424-42B6-858E-07FC00C5B502}", { { "Offset", "Offset 5" }, "%", param_kind::continuous, percentage_01_bounds(0.0f) } },
  { "{72E153D2-4614-4F91-B348-DF7AE0453927}", { { "Offset", "Offset 6" }, "%", param_kind::continuous, percentage_01_bounds(0.0f) } },
  { "{31D9A605-F16B-47AB-B5F4-C03B285D7EDA}", { { "Offset", "Offset 7" }, "%", param_kind::continuous, percentage_01_bounds(0.0f) } },
  { "{9A949AC3-CFF8-49CC-81BC-78B59B2E4F8A}", { { "Offset", "Offset 8" }, "%", param_kind::continuous, percentage_01_bounds(0.0f) } },
  { "{5ACBDB05-BFCF-4A85-809B-D81DB8E835DE}", { { "Scale", "Scale 1" }, "%", param_kind::continuous, percentage_01_bounds(1.0f) } },
  { "{2E03B188-2616-457B-ACC2-F1B735370420}", { { "Scale", "Scale 2" }, "%", param_kind::continuous, percentage_01_bounds(1.0f) } },
  { "{45AE23A8-8EC6-4901-BECE-CB631FDFAA4D}", { { "Scale", "Scale 3" }, "%", param_kind::continuous, percentage_01_bounds(1.0f) } },
  { "{D2937D43-3DEE-4657-A9E0-BD2B1323FA3A}", { { "Scale", "Scale 4" }, "%", param_kind::continuous, percentage_01_bounds(1.0f) } },
  { "{9B15F803-4776-459D-98D8-B5563F217159}", { { "Scale", "Scale 5" }, "%", param_kind::continuous, percentage_01_bounds(1.0f) } }, 
  { "{87F14A8F-2462-4CAE-9E8F-A87F95A20369}", { { "Scale", "Scale 6" }, "%", param_kind::continuous, percentage_01_bounds(1.0f) } },
  { "{DF70143D-441E-4C77-BCF5-6535B4316B64}", { { "Scale", "Scale 7" }, "%", param_kind::continuous, percentage_01_bounds(1.0f) } },
  { "{12EE4A5C-1BA4-4DC5-80B7-0FEF76EA5A59}", { { "Scale", "Scale 8" }, "%", param_kind::continuous, percentage_01_bounds(1.0f) } }
};
