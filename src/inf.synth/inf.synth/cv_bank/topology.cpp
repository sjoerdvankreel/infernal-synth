...
{
  { "{CE1DC1C7-72C5-4811-8C35-8485FFAFFABC}", { {"Tgt", "Target"}, "", param_kind::ui, param_type::list, {&vcv_route_output_target_list, "Voice Gain" } } },
  { "{41FB9033-220C-4DA7-836A-22808E17167F}", { { "Key", "Key hold" }, "Sec", param_kind::ui, quad_bounds(0.01f, 70.0f, "0.5", 2) } }
};

param_descriptor const
gcv_plot_params[cv_plot_param::count] =
{
  { "{EBF618A3-D50D-439C-A2BA-95C06277276E}", { {"Tgt", "Target"}, "", param_kind::ui, param_type::list, {&gcv_route_output_target_list, "Master Gain" } } },
