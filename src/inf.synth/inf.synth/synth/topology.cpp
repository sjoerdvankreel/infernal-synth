...
synth_topology::init_fx_factory_preset(param_value* state) const
{
  ...
  set_ui_value(state, part_type::gaudio_bank, 1, audio_bank_param::in7, "Ext");
  set_ui_value(state, part_type::gaudio_bank, 1, audio_bank_param::out7, "Master");
...
{                       
  ...
  { "{7A77C027-FC8F-4425-9BF0-393267D92F0C}", { "Audio A", "Audio Bank A" }, part_kind::input, part_type::vaudio_bank, 1, vaudio_bank_params, audio_bank_param::vaudio_count, nullptr },
  { "{B5B4A442-13ED-43ED-B9E0-3B2894D03838}", { "Audio B", "Audio Bank B" }, part_kind::input, part_type::gaudio_bank, 1, gaudio_bank_params, audio_bank_param::gaudio_count, nullptr },
  ...
  { "{30B485EC-0EDC-4792-9ED1-8AE5A3349096}", { "CV B Plot", "CV Bank B Plot" }, part_kind::input, part_type::gcv_plot, 1, gcv_plot_params, cv_plot_param::count, nullptr },
