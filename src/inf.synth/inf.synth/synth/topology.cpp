...
static part_ui_descriptor const vaudio_bank_ui = { 4, vaudio_bank_special, { }, part_colors, vaudio_bank_borders(), &vaudio_bank_table, connector_direction::left_right, "greed.png", 200, "", false};
static part_ui_descriptor const gaudio_bank_ui = { 4, gaudio_bank_special, { }, part_colors, gaudio_bank_borders(), &gaudio_bank_table, connector_direction::left_right | connector_direction::down, "envy.png", 100, "Global", false};
