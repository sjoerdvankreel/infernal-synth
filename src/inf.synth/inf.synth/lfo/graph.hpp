#ifndef INF_SYNTH_LFO_GRAPH_HPP
#define INF_SYNTH_LFO_GRAPH_HPP
...
public:
  ...
  lfo_graph(base::topology_info const* topology, base::part_id id, std::vector<float>* raw_data_storage);
};
