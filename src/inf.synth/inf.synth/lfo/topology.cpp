...
static param_descriptor_data const lfo_on_data = { { "On", "Enabled" }, param_kind::voice, false }; 
...
static param_descriptor_data const lfo_basic_offset_data = { { "Offset", "Basic phase offset" }, "%", param_kind::voice, percentage_01_bounds(0.0f) };
static param_descriptor_data const lfo_basic_pw_data = { { "PW", "Basic pulse width" }, "%", param_kind::voice, percentage_01_bounds(1.0f) };
...
static param_descriptor_data const lfo_rand_seedx_data = { { "SeedX", "Random step seed" }, "", param_kind::voice, param_type::knob, { 1, 256, 1 } };
static param_descriptor_data const lfo_rand_seedy_data = { { "SeedY", "Random level seed" }, "", param_kind::voice, param_type::knob, { 1, 256, 1 } };
static param_descriptor_data const lfo_rand_rand_steps_data = { { "Rand steps", "Randomize steps" }, param_kind::voice, false };
...
static param_descriptor_data const lfo_custom_delay1_data = { { "Delay", "Custom delay 1" }, "%", param_kind::voice, percentage_01_bounds(0.5f) }; 
static param_descriptor_data const lfo_custom_rise1_data = { { "Rise", "Custom rise 1" }, "%", param_kind::voice, percentage_01_bounds(0.5f) };
static param_descriptor_data const lfo_custom_rise1_slope_data = { { "Slope", "Custom rise 1 slope" }, "", param_kind::voice, param_type::list_knob, discrete_2way_bounds(lfo_slope_range, 1) };
static param_descriptor_data const lfo_custom_hold1_data = { { "Hold", "Custom hold 1" }, "%", param_kind::voice, percentage_01_bounds(0.5f) };
static param_descriptor_data const lfo_custom_fall1_data = { { "Fall", "Custom fall 1" }, "%", param_kind::voice, percentage_01_bounds(0.5f) };
static param_descriptor_data const lfo_custom_fall1_slope_data = { { "Slope", "Custom fall 1 slope" }, "", param_kind::voice, param_type::list_knob, discrete_2way_bounds(lfo_slope_range, 1) };
static param_descriptor_data const lfo_custom_delay2_data = { { "Delay", "Custom delay 2" }, "%", param_kind::voice, percentage_01_bounds(0.5f) }; 
static param_descriptor_data const lfo_custom_fall2_data = { { "Fall", "Custom fall 2" }, "%", param_kind::voice, percentage_01_bounds(0.5f) };
static param_descriptor_data const lfo_custom_fall2_slope_data = { { "Slope", "Custom fall 2 slope" }, "", param_kind::voice, param_type::list_knob, discrete_2way_bounds(lfo_slope_range, 1) };
static param_descriptor_data const lfo_custom_hold2_data = { { "Hold", "Custom hold 2" }, "%", param_kind::voice, percentage_01_bounds(0.5f) }; 
static param_descriptor_data const lfo_custom_rise2_data = { { "Rise", "Custom rise 2" }, "%", param_kind::voice, percentage_01_bounds(0.5f) };
static param_descriptor_data const lfo_custom_rise2_slope_data = { { "Slope", "Custom rise 2 slope" }, "", param_kind::voice, param_type::list_knob, discrete_2way_bounds(lfo_slope_range, 1) };
