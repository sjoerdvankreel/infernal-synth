...
{     
  ...
  { "{AFA9850B-ACB0-4666-95C0-42D32D197EB2}", { { "Source", "Ring/amplitude modulation source" }, "", param_kind::voice, param_type::knob_list, { &osc_ram_sources, 0 } } },
  { "{4ED08060-260A-42EC-99E8-A2BEA628B652}", { { "Balance", "Ring/amplitude modulation balance" }, "%", param_kind::continuous, percentage_m11_bounds(1.0f) } },
  { "{63C3C4F7-526A-4A1C-BD12-99548A765110}", { { "Dry/Wet", "Ring/amplitude modulation mix" }, "%", param_kind::continuous, percentage_01_bounds(0.0f) } },
  ...
  { "{70C38B3D-E81C-42D9-A59A-9619DB318DFD}", { { "Detune", "Unison detune" }, "%", param_kind::continuous, percentage_01_bounds(0.0f) } }, 
  { "{412B4D8D-4272-40ED-949F-479FB8407BF7}", { { "Spread", "Unison stereo spread" }, "%", param_kind::continuous, percentage_01_bounds(0.0f) } },
