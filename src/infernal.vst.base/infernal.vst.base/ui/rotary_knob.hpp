...
{
  svn::base::knob_ui_colors const _colors;
public:
  CLASS_METHODS(rotary_knob, CKnobBase)
  void draw(VSTGUI::CDrawContext* context) override;
public:
  explicit rotary_knob(svn::base::knob_ui_colors const& colors):
...
{
public:
  VSTGUI::IdStringPtr getViewName() const override { return "svn_rotary_knob"; }
