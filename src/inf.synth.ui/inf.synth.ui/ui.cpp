...
create_synth_ui(std::int32_t width)
{
  ...
  result->look_and_feel().setColour(inf_look_and_feel::colors::knob_highlight, Colour(0xFFCC0000));
  result->look_and_feel().setColour(inf_look_and_feel::colors::knob_cuts_inward, Colour(0xFFFFFFFF));
  result->look_and_feel().setColour(inf_look_and_feel::colors::knob_cuts_outward, Colour(0x00FFFFFF));
