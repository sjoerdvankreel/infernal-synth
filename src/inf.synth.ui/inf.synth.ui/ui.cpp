...
create_synth_ui(plugin_controller* controller)
{
  ...
  osc_grid->add_cell(create_oscillator_grid(controller, 0), 0, 0);
  osc_grid->add_cell(create_oscillator_grid(controller, 1), 0, 1);
  osc_grid->add_cell(create_oscillator_grid(controller, 2), 1, 0);
  osc_grid->add_cell(create_oscillator_grid(controller, 3), 1, 1);
