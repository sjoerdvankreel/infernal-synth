...
create_osc_main_group()
{
  ...
  grid->add_cell(create_param_ui(part_type::vosc, 0, osc_param::kbd, label_display_type::both, false), 2, 0);
...
{
  auto grid = create_grid_ui(3, 1);
  grid->add_cell(create_param_ui(part_type::vosc, 0, osc_param::note, label_display_type::value, false), 0, 0);
  grid->add_cell(create_param_ui(part_type::vosc, 0, osc_param::oct, label_display_type::value, false), 1, 0);
  grid->add_cell(create_param_ui(part_type::vosc, 0, osc_param::cent, label_display_type::value, true), 2, 0);
...
create_osc_sync_group()
{
  ...
  grid->add_cell(create_param_ui(part_type::vosc, 0, osc_param::sync_src, label_display_type::value, false), 0, 0);
  grid->add_cell(create_param_ui(part_type::vosc, 0, osc_param::fm, label_display_type::label, true), 0, 1);
...
create_osc_type_group()
{
  ...
  grid->add_cell(create_param_ui(part_type::vosc, 0, osc_param::mix_sine, label_display_type::label, true), 0, 0);
  grid->add_cell(create_param_ui(part_type::vosc, 0, osc_param::mix_saw, label_display_type::label, true), 0, 1);
  grid->add_cell(create_param_ui(part_type::vosc, 0, osc_param::mix_triangle, label_display_type::label, true), 0, 2);
  grid->add_cell(create_param_ui(part_type::vosc, 0, osc_param::mix_pulse, label_display_type::label, true), 0, 3);
  grid->add_cell(create_param_ui(part_type::vosc, 0, osc_param::mix_pw, label_display_type::label, true), 0, 4);
...
create_synth_ui(std::int32_t width)
{
  ...
  result->look_and_feel().setColour(inf_look_and_feel::colors::switch_track_on, Colour(0xFF444444));
  result->look_and_feel().setColour(inf_look_and_feel::colors::switch_track_off, Colour(0xFF222222));
  result->look_and_feel().setColour(inf_look_and_feel::colors::switch_spot_fill_base_on, Colour(0x00222222));
  result->look_and_feel().setColour(inf_look_and_feel::colors::switch_spot_fill_base_off, Colour(0x00222222));
  result->look_and_feel().setColour(inf_look_and_feel::colors::switch_spot_fill_highlight_on, Colour(0x80BBBBBB));
  result->look_and_feel().setColour(inf_look_and_feel::colors::switch_spot_fill_highlight_off, Colour(0x80BBBBBB));
  result->look_and_feel().setColour(inf_look_and_feel::colors::switch_gradient_fill_base_on, Colour(0xFFDA6102));
  result->look_and_feel().setColour(inf_look_and_feel::colors::switch_gradient_fill_base_off, Colour(0xFFDA6102));
  result->look_and_feel().setColour(inf_look_and_feel::colors::switch_gradient_fill_highlight_on, Colour(0xFFFD9A4D));
  result->look_and_feel().setColour(inf_look_and_feel::colors::switch_gradient_fill_highlight_off, Colour(0xFFFD9A4D));
  return result;
}
