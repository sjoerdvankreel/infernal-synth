...
create_lfo_basic_group(plugin_controller* controller, std::int32_t part_type, std::int32_t part_index)
{
  ...
  knob_grid->add_cell(create_param_edit_ui(controller, part_type, part_index, lfo_param::basic_type, edit_type::selector, false), 0, 0, 4, 1);
  knob_grid->add_cell(create_param_icon_ui(controller, part_type, part_index, lfo_param::basic_type, icon_for_lfo_basic_type), 5, 0, 1, 1);
