...
create_synth_ui(plugin_controller* controller)
{
  ...
  result->look_and_feel().setColour(inf_look_and_feel::colors::part_graph_fill_low, Colour(0xFF222222));
  result->look_and_feel().setColour(inf_look_and_feel::colors::part_graph_fill_high, Colour(0xFF333333));
