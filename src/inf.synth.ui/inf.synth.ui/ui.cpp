...
create_osc_main_group(plugin_controller* controller)
{
  ...
  grid->add_cell(create_param_edit_ui(part_type::vosc, 0, osc_param::type, edit_type::dropdown), 2, 0, 1, 1);
  ...
  return create_group_ui(controller, create_group_label_ui("Main", false), std::move(grid));
}
...
create_osc_pitch_group(plugin_controller* controller)
{
  ...
  return create_group_ui(controller, create_group_label_ui("Pitch", false), std::move(grid));
}
...
create_osc_ram_group(plugin_controller* controller)
{
  ...
  return create_group_ui(controller, create_group_label_ui("R/AM", false), std::move(grid));
}
...
create_osc_sync_group(plugin_controller* controller)
{
  ...
  return create_group_ui(controller, create_group_label_ui("Sync", true), std::move(grid));
}
...
create_osc_unison_group(plugin_controller* controller)
{
  ...
  return create_group_ui(controller, create_group_label_ui("Unison", false), std::move(grid));
}
...
create_osc_type_group(plugin_controller* controller)
{
  ...
  return create_group_ui(controller, create_group_label_ui("Mix", true), std::move(grid));
}
...
create_osc_hslider_group(plugin_controller* controller)
{
  ...
  return create_group_ui(controller, create_group_label_ui("HSlide", true), std::move(grid));
}
...
create_osc_vslider_group(plugin_controller* controller)
{
  ...
  return create_group_ui(controller, create_group_label_ui("VSlide", false), std::move(grid));
}
...
create_oscillator_grid(plugin_controller* controller)
{
  ...
  result->add_cell(create_container_fill_ui(create_osc_main_group(controller), Colour(0xFF333333)), 0, 0, 3, 1);
  result->add_cell(create_container_fill_ui(create_osc_pitch_group(controller), Colour(0xFF333333)), 0, 1, 3, 1);
  result->add_cell(create_container_fill_ui(create_osc_ram_group(controller), Colour(0xFF333333)), 0, 2, 3, 1);
  result->add_cell(create_container_fill_ui(create_osc_sync_group(controller), Colour(0xFF333333)), 0, 3, 1, 2);
  result->add_cell(create_container_fill_ui(create_osc_unison_group(controller), Colour(0xFF333333)), 1, 3, 2, 2);
  result->add_cell(create_container_fill_ui(create_osc_type_group(controller), Colour(0xFF333333)), 3, 0, 1, 5);
  result->add_cell(create_container_fill_ui(create_osc_hslider_group(controller), Colour(0xFF333333)), 0, 5, 1, 3);
  result->add_cell(create_container_fill_ui(create_osc_vslider_group(controller), Colour(0xFF333333)), 1, 5, 2, 3);
  return result;
}
...
{
  auto result = create_root_ui(create_oscillator_grid(controller), controller->editor_current_width(), juce::Colours::black);
