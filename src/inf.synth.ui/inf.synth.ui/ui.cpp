...
create_synth_ui(std::int32_t width)
{
  ...
  result->look_and_feel().setColour(inf_look_and_feel::colors::knob_radial_fill_base, Colour(0x00333333));
  result->look_and_feel().setColour(inf_look_and_feel::colors::knob_gradient_fill_base, Colour(0xFF333333));
  result->look_and_feel().setColour(inf_look_and_feel::colors::knob_radial_fill_highlight, Colour(0x80BBBBBB));
