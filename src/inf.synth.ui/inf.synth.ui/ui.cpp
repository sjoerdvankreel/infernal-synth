...
{
  auto outer_grid = create_grid_ui(controller, 3, 6);
  outer_grid->add_cell(create_iconed_param_ui(controller, part_type, part_index, lfo_param::basic_type, edit_type::selector, icon_for_lfo_basic_type, false), 1, 0, 1, 1);
  auto slider_grid = create_grid_ui(controller, 2, 1);
  slider_grid->add_cell(create_labeled_param_ui(controller, part_type, part_index, lfo_param::basic_offset, edit_type::hslider, label_type::label, true), 0, 0);
  slider_grid->add_cell(create_labeled_param_ui(controller, part_type, part_index, lfo_param::basic_pw, edit_type::hslider, label_type::label, true), 1, 0);
  outer_grid->add_cell(std::move(slider_grid), 1, 1, 1, 5);
