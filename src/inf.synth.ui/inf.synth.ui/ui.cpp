...
{
  auto knob_grid = create_grid_ui(controller, 16, 1);
  knob_grid->add_cell(create_param_edit_ui(controller, part_type, part_index, lfo_param::basic_type, edit_type::selector, false), 0, 0, 8, 1);
  knob_grid->add_cell(create_param_icon_ui(controller, part_type, part_index, lfo_param::basic_type, icon_for_lfo_basic_type), 9, 0, 2, 1);
  auto slider_grid = create_grid_ui(controller, 8, 1);
...
create_lfo_random_group(plugin_controller* controller, std::int32_t part_type, std::int32_t part_index)
{
  ...
  other_grid->add_cell(create_labeled_param_ui(controller, part_type, part_index, lfo_param::rand_amt, edit_type::hslider, label_type::label, true, false, 8), 1, 0, 4, 1);
  other_grid->add_cell(create_labeled_param_ui(controller, part_type, part_index, lfo_param::rand_seedy, edit_type::hslider, label_type::label, true, false, 8), 7, 0, 4, 1);
  auto seedx = other_grid->add_cell(create_labeled_param_ui(controller, part_type, part_index, lfo_param::rand_seedx, edit_type::hslider, label_type::label, true, false, 8), 13, 0, 4, 1);
  ...
  rand_steps_grid->add_cell(create_param_label_ui(controller, part_type, part_index, lfo_param::rand_rand_steps, label_type::label, Justification::right), 0, 0);
