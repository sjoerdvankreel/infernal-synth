...
create_root_lnf(plugin_controller* controller)
{
  ...
  result->setColour(inf_look_and_feel::colors::file_box_file_text, Colour(0xFFA7BECB));
  result->setColour(inf_look_and_feel::colors::file_box_file_background, Colour(0xFF333333));
  result->setColour(inf_look_and_feel::colors::file_box_label_text, Colour(0xFFA7BECB));
  ...
  result->setColour(inf_look_and_feel::colors::file_box_selector_text, Colour(0xFFA7BECB));
  result->setColour(inf_look_and_feel::colors::file_box_selector_highlight, Colour(0xFF14525D));
  result->setColour(inf_look_and_feel::colors::file_box_selector_highlight_text, Colour(0xFFA7BECB));
