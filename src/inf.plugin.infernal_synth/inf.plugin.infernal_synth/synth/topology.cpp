...
master_params[master_param::count] =
{
  ...
  { "{8325B6A2-C628-4C40-8AE1-76D5B78CA963}", { { "MIDI Mod", "MIDI Modwheel" }, "%", param_kind::continuous, percentage_01_bounds(0.0f) } },
  { "{E0AC7ADD-218C-44FA-B3A1-0807611E9FB7}", { { "MIDI Vol", "MIDI Channel Volume" }, "%", param_kind::continuous, percentage_01_bounds(1.0f) } },
  { "{7C6B9AD7-BED5-48DD-8ED2-0073B80F1A23}", { { "MIDI CP", "MIDI Channel Pressure" }, "%", param_kind::continuous, percentage_01_bounds(1.0f) } },
  { "{632B9205-8EEC-4CB4-8071-B101195DCB80}", { { "MIDI PB", "MIDI Pitchbend" }, "%", param_kind::continuous, percentage_m11_bounds(0.0f) } },
};
