...
{
  part_type::vaudio_bank, vcv_route_output::vaudio_bank, vaudio_route_output_total_count,
...
{
  part_type::gaudio_bank, gcv_route_output::gaudio_bank, gaudio_route_output_total_count,
