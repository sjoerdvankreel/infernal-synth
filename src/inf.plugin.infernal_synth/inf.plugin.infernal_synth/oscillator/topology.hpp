#ifndef INF_PLUGIN_INFERNAL_SYNTH_OSCILLATOR_TOPOLOGY_HPP
#define INF_PLUGIN_INFERNAL_SYNTH_OSCILLATOR_TOPOLOGY_HPP
...
struct osc_param_t { enum value { 
  on, type, sync_src, kbd, oct, note, cent, pb_range, pitch, pm, fm,
