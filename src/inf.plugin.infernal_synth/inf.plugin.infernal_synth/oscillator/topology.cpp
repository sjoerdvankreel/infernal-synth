...
{     
  ...
  { "{10935D87-24A7-4994-BB9A-D46636933F6F}", { { "Sync", "Sync source" }, "", param_kind::voice, param_type::knob_list, discrete_descriptor { &osc_sync_sources, osc_sync_off }.with_max_selector(osc_max_sync_index) } },
  ...
  { "{D382791F-C308-4B73-A9FE-6B060967A126}", { { "Bend", "Pitchbend range" }, "", param_kind::voice, param_type::list_knob, { 1, 24, 1 } } },
  { "{623414A0-BAE6-413E-8F89-0D2D8EE3CA02}", { { "Pitch", "Pitch" }, "", param_kind::fixed, linear_bounds(-1.0f, 1.0f, 0.0f, -1.0f, 1.0f, 2) } },
  ...
  { "{AFA9850B-ACB0-4666-95C0-42D32D197EB2}", { { "Src", "AM source" }, "", param_kind::voice, param_type::knob_list, discrete_descriptor { &osc_ram_sources, 0 }.with_max_selector(osc_max_ram_index) } },
  { "{4ED08060-260A-42EC-99E8-A2BEA628B652}", { { "Ring", "AM ring" }, "%", param_kind::continuous, percentage_01_bounds(0.0f) } },
  { "{63C3C4F7-526A-4A1C-BD12-99548A765110}", { { "Mix", "AM mix" }, "%", param_kind::continuous, percentage_01_bounds(0.0f) } },
