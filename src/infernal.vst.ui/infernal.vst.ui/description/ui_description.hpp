...
struct param_ui_description
{
  std::int32_t row;
  std::int32_t column;
  svn::base::param_info const* info;
};
...
struct part_ui_description
{
  ...
  svn::base::part_info const* info;
  param_ui_description enabled_param;
  std::vector<param_ui_description> params;

  static part_ui_description create(svn::base::topology_info const& topology, 
    svn::base::part_info const* info, std::int32_t static_part_index, std::int32_t runtime_index);
};
...
struct part_type_ui_description
{
  ...
  svn::base::part_ui_colors colors; // Type ui colors.
  param_ui_description selector_param; // Osc1/2 etc.
  std::vector<part_ui_description> parts;

  static part_type_ui_description
  create(svn::base::topology_info const& topology, svn::base::part_descriptor const& descriptor,
