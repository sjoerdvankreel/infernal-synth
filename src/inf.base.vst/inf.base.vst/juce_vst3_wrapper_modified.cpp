...
namespace juce
{
  // added to resolve overload conflict on Steinberg::SpeakerArrangement
  template <class T>
  T countNumberOfBits(T v)
  { return countNumberOfBits(static_cast<unsigned long long int>(v)); }
}
