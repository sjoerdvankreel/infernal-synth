...
{
public:
  float editor_aspect_ratio() const override { return 2.0f * 1.28f; }
  std::int32_t editor_min_width() const override { return 2 * 384; }
  std::int32_t editor_default_width() const override { return 2 * 600 * 384 / 400; }
  std::int32_t editor_font_scaling_min_width() const override { return 2 * 500 * 384 / 400; }
  std::int32_t editor_font_scaling_max_width() const override { return 2 * 700 * 384 / 400; }
