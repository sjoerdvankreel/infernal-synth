...
#include <svn.vst.synth.fx/plugin.hpp>
...
#if SVN_VERSIONED
static FUID const svn_vst_processor_id(0x88B6D7ED, 0x1B3A4AAE, 0xA9612A67, 0x56F66197);
static FUID const svn_vst_controller_id(0x5E5E1287, 0xDFA148FE, 0xA543CCEE, 0x286FF4DE);
#elif !SVN_VERSIONED
static FUID const svn_vst_processor_id(0x00AE86BB, 0x62E6495B, 0xBB947F2F, 0x7D98CC1A);
static FUID const svn_vst_controller_id(0x101EB406, 0x0A0F4361, 0xBBFF18B5, 0xF566FEBE);
#else
#error
#endif
...
BEGIN_FACTORY_DEF(
  ...
  DEF_CLASS2(
    ...
    SVN_VST_SEVEN_SYNTH_FX_VERSION, kVstVersionString, svn_vst_processor_factory)
  ...
  DEF_CLASS2(
    ...
    SVN_VST_SEVEN_SYNTH_FX_VERSION, kVstVersionString, svn_vst_controller_factory)
END_FACTORY
