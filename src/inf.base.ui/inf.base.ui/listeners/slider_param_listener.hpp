#ifndef INF_BASE_UI_LISTENERS_SLIDER_PARAM_LISTENER_HPP
#define INF_BASE_UI_LISTENERS_SLIDER_PARAM_LISTENER_HPP
...
#endif // INF_BASE_UI_LISTENERS_SLIDER_PARAM_LISTENER_HPP