...
{
  if(_last_param_index == index && _editor->hasKeyboardFocus(true)) return;
  ...
  _editor->setText(_controller->topology()->params[index].descriptor->data.format(false, value), false);
