...
inline int const button_margin = 5;
...
inline float const toggle_max_size_max = 38.0f;
...
inline float const selector_max_height = 44.0f;
inline float const selector_vlabel_pad_min = 2.0f;
inline float const selector_vlabel_pad_max = 7.0f;
inline float const selector_font_min_height = 11.0f;
inline float const selector_font_max_height = 17.0f;

inline float const dropdown_hpad = 4.0f;
inline float const dropdown_vpad_min = 6.0f;
inline float const dropdown_vpad_max = 19.0f;
...
inline float const dropdown_font_max_height = 16.0f;
...
inline float const param_label_font_max_height = 16.0f;

inline float const button_label_font_min_height = 11.0f;
inline float const button_label_font_max_height = 17.0f;

inline float const group_label_vpad = 7.0f;
inline float const group_label_font_min_height = 11.0f;
inline float const group_label_font_max_height = 17.0f;
