...
{ return get_scaled_text_size(controller, dropdown_font_min_height, dropdown_font_max_height); }
inline float
get_dropdown_total_height(inf::base::plugin_controller const* controller)
{ return get_dropdown_font_height(controller) + dropdown_vpad; }
