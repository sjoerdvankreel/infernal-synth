...
public:
  virtual void layout(plugin_controller* controller) = 0;
...
public:
  void layout(plugin_controller* controller) override;
...
public:
  void layout(plugin_controller* controller) override;
  std::int32_t pixel_height(plugin_controller* controller);
