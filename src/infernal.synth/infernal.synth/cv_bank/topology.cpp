...
static list_item const vgcv_route_effect_targets[vgcv_route_effect_target::count] = {
  ...
  { "{AA6A7470-0DD3-4E87-8CD0-FC8F957DC597}", "Dly AmtL" },
  { "{63B16DED-0E98-4D56-8F92-8AB123D9F9F7}", "Dly AmtR" },
  { "{E5AB32E2-F8F0-46F8-BA47-F055523D325F}", "Dly Sprd" },
  { "{5136DA49-8D93-46AB-97B3-1CFE69E02448}", "Dly Amt" },
